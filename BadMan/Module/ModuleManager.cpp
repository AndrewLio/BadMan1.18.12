...
void ModuleManager::initModules() {
	{
		...
		moduleList.push_back(std::shared_ptr<IModule>(new AntiKAFag()));
		...
		moduleList.push_back(std::shared_ptr<IModule>(new HoleTP()));
		...
		moduleList.push_back(std::shared_ptr<IModule>(new NukeSpeed()));
		...
		moduleList.push_back(std::shared_ptr<IModule>(new HoleSwap()));
		...
		moduleList.push_back(std::shared_ptr<IModule>(new Timer1()));
	...
	getModule<Welcome>()->setEnabled(true);
}
