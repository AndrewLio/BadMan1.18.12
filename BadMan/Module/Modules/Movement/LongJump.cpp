...
using namespace std;
LongJump::LongJump() : IModule(0, Category::MOVEMENT, u8"Ô¶Ìø") {
...
const char* LongJump::getModuleName() {
	if (mode.getSelectedValue() == 0) name = string("LongJump ") + string(GRAY) + string("[") + string(WHITE) + string("Vanilla") + string(GRAY) + string("]");
	if (mode.getSelectedValue() == 1) name = string("LongJump ") + string(GRAY) + string("[") + string(WHITE) + string("Old") + string(GRAY) + string("]");
	if (mode.getSelectedValue() == 2) name = string("LongJump ") + string(GRAY) + string("[") + string(WHITE) + string("Hive") + string(GRAY) + string("]");
	if (mode.getSelectedValue() == 3) name = string("LongJump ") + string(GRAY) + string("[") + string(WHITE) + string("Cubecraft") + string(GRAY) + string("]");
	return name.c_str();
}
